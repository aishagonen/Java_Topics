...
// To convert a linked list to an Arraylist :
		...
		linkedLst.add("Shakir");
		linkedLst.add("Necati");
		linkedLst.add("Remzi");
		linkedLst.add("Kadriye");
		
// 1.way: 		
		List<String> aList = new ArrayList<String>(linkedLst);
	      
		System.out.println("The ArrayList elements are: ");
	      for (String strL : aList) {
	         System.out.println(strL);
	     }
	      System.out.println();

// 2.way:	      
	      ArrayList<String> arList = new ArrayList<>(linkedLst);
	        
	       System.out.println("The ArrayList elements are: " + arList);
	       System.out.println();
...
System.out.println("********************	QUEUE    *************************");
		...
		Queue<String> queue = new LinkedList<String>(); //"LinkedList yazdik cunku interface'den obje olusturamayiz. Queue'ler interface'tir.
		...
		System.out.println("Queue printed [side by side] : ");
		System.out.println(queue);
		System.out.println();
		
		Iterator iteratorQ = queue.iterator();
		
		System.out.println("Queue with while loop by Iterator : ");
		...
		System.out.println(queue.poll());  // 'queue.poll()'u, 'syso()'nun icinde yazdigim icin, ilk indexteki poll ettigini gosterir.
...
System.out.println("********************	PRIORITY QUEUE    *************************");
		...
		System.out.println("PriorityQueue printed [side by side] : ");
		System.out.println(priorityQueue);
		System.out.println();
		
		Iterator iteratorPQ = priorityQueue.iterator();
		
		System.out.println("PriorityQueue with while loop by Iterator : ");
		...
		Object [] p = priorityQueue.toArray(); 	// PriorityQueue to Array:
...
//2.w:		
		...
		System.out.println();  
//3w:
		System.out.println("Integer HashSet printed with foreach : ");
		for (Integer integer : hush) {
			System.out.println(integer);
		}
		System.out.println(); 
		
// HashSet to Array:		
		Object [] h = hush.toArray(); 	
...
* LIST : 
		- LinkList, Vector ve ArrayList; List sinifindan gelir. Ozellikleri birbirine benzer.
